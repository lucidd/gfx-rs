...
fn set_mipmap_range(gl: &gl::Gl, target: GLenum, (base, max): (u8, u8)) {
...
pub fn bind_sampler(gl: &gl::Gl, anchor: BindAnchor, info: &tex::SamplerInfo) {
...
pub fn make_sampler(gl: &gl::Gl, info: &tex::SamplerInfo) -> Sampler {
